...
<div class="header">
        ...
        <div>
            <a href="homepage.php" style="margin-left: 600px;" class="headertext">Home</a>  
            <div class="dropdown">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="#">Toggle DarkMode<button id="dark-mode-toggle" class="dark-mode-toggle" aria-label="toggle dark mode">
