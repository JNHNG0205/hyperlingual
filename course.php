...
<head>
    ...
    <title>HyperLingual | Courses</title>  
...
<body>  
    <div class="header">
        ...
        <div>
            <a href="homepage.php" style="margin-left: 650px;" class="headertext">Home</a>  
            <div class="dropdown">
    ...
    <div class ="wrapper">
        <div>
            <button class="coursebutton" onclick= "courseRedirect('English')"><img src="uk.png" alt="" class="courseimg">English</button>
        </div>
        <div>
            <button class="coursebutton" onclick= "courseRedirect('Japanese')"><img src="japan.png" alt="" class="courseimg">Japanese</button>
        </div>
        <div>
            <button class="coursebutton" onclick="courseRedirect('Spanish')"><img src="spain.png" alt="" class="courseimg">Spanish</button>
        </div>
        <div>
            <button class="coursebutton" onclick="courseRedirect('Malay')"><img src="malaysia.png" alt="" class="courseimg">Malay</button>
        </div>
        <div>
            <button class="coursebutton" onclick="courseRedirect('Chinese')"><img src="china.png" alt="" class="courseimg">Chinese</button>
        </div>
        <div>
            <button class="coursebutton" onclick="courseRedirect('French')"><img src="france.png" alt="" class="courseimg">French</button>
        </div>
    </div>
</body> 
</html>